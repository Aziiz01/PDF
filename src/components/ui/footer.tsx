...
<footer className="bg-white dark:bg-gray-900 mt-5">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              ...
              <Image height={20} width={20} alt="Logo" src="/favicon.ico" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PDFSnap</span>
              </a>
          </div>
          <div className="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">More AI Tools🤖 </h2>
                  <ul className="text-gray-400 dark:text-gray-400 font-medium">
                      <li className="mb-2">
                          <div  className="hover:underline">AI Code generator</div>
                      </li>
                      
                      <li className="mb-2">
                          <div  className="hover:underline">AI Image generator</div>
                      </li>
                      <li className="mb-2">
                          <div  className="hover:underline">View more Tools🤖</div>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">PDFSnap</a>. All Rights Reserved.
          </span>
